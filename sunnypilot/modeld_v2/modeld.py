...
from openpilot.sunnypilot.modeld_v2.fill_model_msg import fill_model_msg, fill_driving_model_data, fill_pose_msg, PublishState, get_curvature_from_output
...
def main(demo=False):
  ...
  while True:
    ...
    sm.update(0)
    desire = DH.desire
    is_rhd = sm["driverMonitoringState"].isRHD if sm.alive["driverMonitoringState"] else params.get_bool("IsRhdDetected")
